...
final class EntityByFingerprintGroup extends AbstractDTO implements BodyInterface
{
    use HasToBody;
    ...
    public function __construct(
        public readonly EntityByFp $entityByFp,
    ) {
        $this->subjectDetailsType = SubjectDetailsType::EntityByFingerprint;
    }
}
