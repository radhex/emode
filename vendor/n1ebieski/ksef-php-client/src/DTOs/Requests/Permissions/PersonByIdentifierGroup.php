...
final class PersonByIdentifierGroup extends AbstractDTO implements BodyInterface
{
    use HasToBody;
    ...
    public function __construct(
        public readonly PersonById $personById,
    ) {
        $this->subjectDetailsType = SubjectDetailsType::PersonByIdentifier;
    }
}
