...
<script src="/modules/backend/assets/js/vendor/jquery.min.js?v1.2.8"></script>
...
<script src="/modules/backend/widgets/lists/assets/js/october.list.js?v=1.2.3"></script>
    <style>
        ...
        .layout #layout-mainmenu.navbar ul li.active a i {color: #var(--md1color)}
        ...
        .flash-message.success{background: #f3fbf0;border: 1px solid #52a838; color: #52a838}
        .flash-message.error{background:#fee5e5;border: 1px solid red; color: red}
        .flash-message.warning{background:#ffecd2;border: 1px solid #db8509; color: #db8509}
    ...
    <h4><?= Lang::get('eprog.manager::lang.page_'.$msg, [], Session::get('locale') ?? 'pl'); ?></h4>
    <p id="desc" style="<?php if(explode("//",env("APP_URL"))[1] != "demo.emode.pl") echo "display:none" ?>"><?= $desc ?></p>
