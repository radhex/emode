...
class Zus extends Controller
{
    ...
    public function __construct(){
        ...
        parent::__construct();
        BackendMenu::setContext('Eprog.Manager', 'accounting', 'zus');
    ...
    public function formExtendFields($form)
    {
        ...
        if(Input::segment(5) == "update") { 
            ...
            $form->getField('social')->value = number_format($form->getField('social')->value,2,","," ");
            $form->getField('health')->value = number_format($form->getField('health')->value,2,","," ");
    ...
    public function onExport()
    {
        ...
        $url = config('cms.backendUri')."/eprog/manager/export/zusxml";
        $arg = "";
