...
use RainLab\Translate\Classes\Translator;
    ...
    $value = Ordervalue::where("order_id","=",$id)->get();
...
<style>
    ...
    .invoicepdf .product td{padding-left:5px;padding-right:5px;font-size:12px;border-left:1px solid #333;border-top:1px solid #333;text-align:right;padding-top:6px}
...
<div id="register" >
    <div class="margin-register">
        ...
        <div class="invoicepdf">
            <div style="text-align:right"><?= $input->place ?>: <?= Util::dateFormat($input->date,"d-m-Y") ?><?= Util::timeZoneOffset(); ?></div>
            ...
            <div style="text-align:center;font-size:22px;padding-top:10px"><?= e(trans("eprog.manager::lang.order_one")) ?> <?= lcfirst(e(trans("eprog.manager::lang.nr_short"))) ?> <?= $input->nr ?></div>
        ...
        $l = 0; 
            ...
            $l++;
                    ...
                    ?>
                    <tr><td class="acenter"><?= $l ?></td><td class="aleft"><?= $val->product ?></td> <td><?= $val->quantity ?></td><td><?= $val->measure ?></td><td><?= Util::currency($val->netto) ?></td><td><?= $val->vat ?></td><td><?= Util::currency($netto) ?></td><td><?= Util::currency($vat) ?></td><td class="right"><?= Util::currency($brutto) ?></td></tr>
                <?php endforeach ?>
