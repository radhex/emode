...
<div class="title"><?= $serwis->name ?></div>

<div class="printer">

<div><div  class="head">ID</div><div><?= $serwis->id ?></div></div>


<div><div  class="head"><?= e(trans('eprog.manager::lang.start')) ?></div>
<div>
<?= Util::dateLocale($serwis->start, 'Y-m-d H:i'); ?>
</div>
</div>

<div><div  class="head"><?= e(trans('eprog.manager::lang.stop')) ?></div>
<div>
<?= Util::dateLocale($serwis->stop, 'Y-m-d H:i'); ?>
</div>
</div>

<div><div  class="head"><?= e(trans('eprog.manager::lang.status')) ?></div>
<div>
<?= Util::getStatus($serwis->status_id); ?>
</div>
</div>
...
<div>
<?= $serwis->user->name ?> <?= $serwis->user->surname ?> - <?= $serwis->user->email ?> 
<?php if($serwis->user->phone != null) : ?>
<br><?= strtolower(e(trans('rainlab.user::lang.user.phone'))) ?> <?= $serwis->user->phone ?>
<?php endif; ?>

<br><?= $serwis->user->street ?> <?= $serwis->user->number ?>
<br><?= $serwis->user->code ?> <?= $serwis->user->city ?>
</div>
</div>
<?php endif; ?>
