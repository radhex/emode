 ...
 */
class FileUpload extends \Extends\Backend\FormWidgets\FileUpload
{
    ...
    protected function checkUploadPostback()
    {
        ...
        try
        {
            ...
            {
                throw new ApplicationException(e(trans('responsiv.uploader::lang.file_missing')));
            }
            ...
            $validation = Validator::make(
                ...
                ['max_files' => e(trans('responsiv.uploader::lang.max_files'))]
            );
            ...
            {
                throw new ApplicationException(e(trans('responsiv.uploader::lang.not_valid')));
            }
     ...
     * @return string
     */
    public function getViewPath(string $fileName, array|string|null $viewPaths = null): string
    {
        $returnPaths = [];
