        ...
        <?php if ($singleFile): ?>
            <div class="upload-object is-success" data-id="<?= $singleFile->id ?>" data-path="<?= $singleFile->pathUrl ?>">
                ...
                <?php
                    ...
                    $icon = ["icon" => "icon-file-archive-o", "color" => "000"];//Util::driveIcon($singleFile-content_type);

                ?>
                
                <div class="icon-container">
                    <i class="<?= $icon["icon"] ?>" style="font-size:22px;margin-top:-7px;color:<?= $icon["color"] ?>"></i>
                </div>
                <div class="info">
                    <h4 class="filename">
...
<script type="text/template" id="<?= $this->getId('template') ?>">
    <div class="upload-object dz-preview dz-file-preview">
        <div class="icon-container">
            <i class="icon-file-o" style="font-size:22px;margin-top:-7px;color:#222"></i>
