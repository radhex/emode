<div class="loading-indicator-container size-small pull-right">
    <div class="control-pagination">
        <span class="page-iteration">
           ...
           <!--<?= e(trans('eprog.manager::lang.summary')).": ".$recordTotal ?>-->
        </span>
        <?php if ($pageLast > 1): ?>
            <?php if ($pageCurrent > 1): ?>
                <a
                    ...
                    data-request-success="paginateUrl(1);"
            ...
            <?php if ($pageCurrent > 1): ?>
                <a
                    ...
                    data-request-success="paginateUrl(<?= $pageCurrent-1 ?>);"
                    data-load-indicator="<?= e(trans('backend::lang.list.loading')) ?>"
            ...
            <select
                ...
                data-request="<?= $this->getEventHandler('onPaginate') ?>"
                data-request-success="paginateUrl($('#page option:selected').text());"
                data-load-indicator="<?= e(trans('backend::lang.list.loading')) ?>"
                autocomplete="off">
            ...
            <?php if ($pageLast > $pageCurrent): ?>
                <a
                    ...
                    data-request="<?= $this->getEventHandler('onPaginate') ?>"
                    data-request-success="paginateUrl(<?= $pageLast ?>);"
                    data-load-indicator="<?= e(trans('backend::lang.list.loading')) ?>"
