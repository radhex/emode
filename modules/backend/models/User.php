...
class User extends UserBase
{
    ...
    {
        $count  = $this->where("is_superuser","!=",1)->count(); 

        if($count >= \Config::get("app.limit"))  
        throw new \ValidationException(['my_field'=> trans('eprog.manager::lang.limit_error')]);
    }
    ...
    public function sendInvitation()
    {
        ...
        try {
            ...
            throw new \October\Rain\Exception\ValidationException(['my_field'=>e(trans("eprog.manager::lang.admin_emailerror"))]);
        }
    }
