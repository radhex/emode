        ...
        <div class="layout">
            ...
            <div class="form-buttons">
                <div class="loading-indicator-container">
                    ...
                    <a href="/<?= config('cms.backendUri') ?>/eprog/manager/feed/login_admin/<?= Input::segment(5) ?>" class="btn btn-primary oc-icon-lock" style="margin-left:50px"><?= e(trans('backend::lang.account.login')) ?></a>
                    <?php endif ?>
