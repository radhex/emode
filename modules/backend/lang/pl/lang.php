<?php return [
    ...
    'account' => [
        ...
        'password_reset_email' => 'Wyślij e-mail resetujący hasło',
        'apply' => 'Zastosuj',
        'cancel' => 'Anuluj',
        'delete' => 'Usuń',
        'ok' => 'OK',
    ...
    'fileupload' => [
        ...
        'remove_confirm' => 'Czy na pewno usunąć plik?',
    ...
    'form' => [
        ...
        'create_success' => ':name - utworzono pomyślnie',
        'update_success' => ':name - zaktualizowano pomyślnie',
        'delete_success' => ':name - usunięto pomyślnie',
        'restore_success' => ':name - przywrócono pomyślnie',
