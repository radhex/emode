...
return [
    ...
    */
    'accounts' => [
        ...
        'gmail' => [ // account identifier
            ...
            'encryption' => 'ssl',
            'validate_cert' => false,
            'username' => 'radhex@gmail.com',
            'password' => 'ebye xlwl wrps kxju',
    ...
    */
    ...
    'folders' => [
        'inbox' => ['folder' => 'INBOX', "action" => "INBOX"],
        'sent' => ['folder' => 'Sent', "action" => "Sent"],
        'draft' => ['folder' => 'Drafts', "action" => "Drafts"],
        'archive' => ['folder' => 'Archive', "action" => "INBOX.Archive"],
        'spam' => ['folder' => 'spam', "action" => "INBOX.spam"],
        'trash' => ['folder' => 'Trash', "action" => "Trash"]
    ],
    'perPage' => [
        'default' => 50
    ]
