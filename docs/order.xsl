...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tns="http://crd.gov.pl/wzor/2025/06/25/13775/" version="1.0">
      ...
      <div class="header-info-wrapper">
        <div class="header-info">
          <span class="label-data-info">
            <span class="label-data-info--value">Numer zamówienia</span>
          </span>
          <span class="label-data-info">
  ...
  <xsl:template name="Szczegoly">
    <div class="section-data">
      ...
      <span class="label-data-info label-data-info--half">
        <span class="label-data-info--name">Data wystawienia: </span>
      ...
      <div class="section-data">
        ...
        <xsl:if test="tns:Fa/tns:FaWiersz">
          ...
          <xsl:if test="(tns:Fa/tns:FaWiersz/tns:P_9A | tns:Fa/tns:FaWiersz/tns:P_9B) and not(tns:Fa/tns:OkresFaKorygowanej)">
            ...
            <span class="label-data-info">
              <span class="label-data-info--name">
                Zamówienie wystawione w cenach <xsl:value-of select="$NettoBrutto"/> w walucie <xsl:value-of select="tns:Fa/tns:KodWaluty"/>
              </span>
            </span>
          </xsl:if>
          ...
          <table class="table-basic table-basic--wide">
            <thead>
              <tr>
                ...
                <th class="table-basic__header" style="width:30%">Nazwa towaru lub usługi</th>
      ...
      <div class="section-data">
        ...
        <xsl:if test="tns:Fa/tns:Zamowienie/tns:ZamowienieWiersz">
          ...
          <xsl:if test="tns:Fa/tns:Zamowienie/tns:ZamowienieWiersz/tns:P_9AZ">
            <span class="label-data-info">
              <span class="label-data-info--name">Zamówienie wystawione w cenach netto w walucie <xsl:value-of select="tns:Fa/tns:KodWaluty"/></span>
            </span>
          </xsl:if>
  ...
  <xsl:template name="Platnosc">
    ...
    <xsl:if test="tns:Fa/tns:Platnosc/tns:IPKSeF">
      <div class="section-data">
        <span class="label-data-info">
          <span class="label-data-info--name">Identyfikator płatności KSeF: </span>
    ...
    <xsl:if test="tns:Stopka/tns:Informacje/tns:StopkaFaktury">
      ...
      <div class="section-data">
        ...
        <table class="table-basic">
          <thead>
            <tr>
              <th class="table-basic__header table-basic__header--medium-size">Stopka</th>
            </tr>
          </thead>
          <tbody>
