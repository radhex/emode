      ...
      <div class="header-info-wrapper">
        <div class="header-info">
          <span class="label-data-info">
            <span class="label-data-info--value" style="font-size:20px">Faktura PRO Forma</span>
          </span>
          <span class="label-data-info">
            <span class="label-data-info--value2" style="font-size:18px"><xsl:value-of select="tns:Fa/tns:P_2"/></span>
          </span>
        </div>
      </div>
    </div>
