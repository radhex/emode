...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tns="http://crd.gov.pl/wzor/2025/06/25/13775/" version="1.0" exclude-result-prefixes="tns">
    ...
    <div class="main-header">
      ...
      <div class="header-info-wrapper">
        <div class="header-info">
          ...
          <span class="label-data-info">
            <span class="label-data-info--value2" style="font-size:20px"><xsl:value-of select="tns:Fa/tns:P_2"/></span>
          </span>
          <span class="label-data-info">
  ...
  <xsl:template name="QRCode">
      <div class="line-basic" style="height:{{height}}px;font-size:12px;background:#ffffff">{{QRCode}}</div>
  </xsl:template>
