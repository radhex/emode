    ...
    <div class="main-header">
      ...
      <div class="header-info-wrapper">
        <div class="header-info">
          ...
          <span class="label-data-info">
            <span class="label-data-info--name">Nr KSeF: </span>
            <span class="label-data-info--value">{{NrKsef}}</span>
          </span>
        </div>
      </div>
    </div>
            ...
            <div class="section-data__wrapper-left">
              ...
              <xsl:if test="tns:Fa/tns:P_15ZK">
                <span class="label-data-info">
                  ...
                  <span class="label-data-info--value" style="margin-left:5px"><xsl:value-of select="tns:Fa/tns:KodWaluty"/></span>
                </span>
              </xsl:if>
